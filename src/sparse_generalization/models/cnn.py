...
class BasicCNN(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.layers.extend([
            nn.Conv2d(in_channels=model_dim if embedding_inp else input_dim, out_channels=hidden_dims[0], kernel_size=3, padding=1), 
            act(),
        ])
        ...
        self.ffn.extend([
            nn.Linear(in_features=out.size(2) * out.size(3) * hidden_dims[-1], out_features=64),
            act(),
            nn.Dropout(dropout), 
