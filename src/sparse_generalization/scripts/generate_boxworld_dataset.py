...
def generate_dataset(
    ...
    env_solv_test = make_env(size=10, num_pairs=3, unsolvable_prob=0.0, num_paths=num_paths, ood_colors=True)
    env_unsolv_test = make_env(size=10, num_pairs=3, unsolvable_prob=1.0, num_paths=num_paths, ood_colors=True)

    for env, label, count in [(env_solv_test, 1, num_solv_test), (env_unsolv_test, 0, num_unsolv_test)]:
        env.reset(seed=start_seed)
    ...
    env_solv_test = make_env(size=10, num_pairs=-1, unsolvable_prob=0.0, num_paths=num_paths)
    env_unsolv_test = make_env(size=10, num_pairs=-1, unsolvable_prob=1.0, num_paths=num_paths)
    ...
    env_solv_test = make_env(size=10, num_pairs=3, unsolvable_prob=0.0, num_paths=num_paths, num_distractors=5)
    env_unsolv_test = make_env(size=10, num_pairs=3, unsolvable_prob=1.0, num_paths=num_paths, num_distractors=5)
    ...
    env_solv_test = make_env(size=10, num_pairs=-1, unsolvable_prob=0.0, num_paths=num_paths, num_distractors=5, ood_colors=True)
    env_unsolv_test = make_env(size=10, num_pairs=-1, unsolvable_prob=1.0, num_paths=num_paths, num_distractors=5, ood_colors=True)
