...
def main(cfg: DictConfig):
    ...
    if cfg.seeds is None:
        ...
        trainer = Trainer(
            **cfg.trainer, default_root_dir="../../checkpoints/", logger=logger
        )
        ...
        table.add_data(
            "Test set Expl. 1",
            test_metrics_1[0]["test_loss"],
            test_metrics_1[0]["test_acc"],
        )
        table.add_data(
            "Test set Expl. 2",
            test_metrics_2[0]["test_loss"],
            test_metrics_2[0]["test_acc"],
        )
